...
int	cgr_identify_best_routes(IonNode *terminusNode, Bundle *bundle, Lyst excludedNodes, 
...
int	cgr_preview_forward(uvast terminusNodeNbr, Bundle *bundle, time_t atTime, CgrSAP sap, CgrTrace *trace) 
{
	return 0;
}
