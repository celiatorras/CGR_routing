...
Therefore, we have inserted here the solution provided to us by Patricia Lindner, of Ohio University, which consists of the following files: Makefile.am, Makefile.noBP, bpv7_Makefile, configure.ac. 
Note that bpv7_Makefile compiles Unibo-CGR with the RGR and CGRR extensions.
